...
<%@ page import="common.CommonUtil,dao.Event_M_DAO,dto.Event_M_DTO"%>
<%
	...
	Event_M_DTO dtoM = new Event_M_DTO();
	dtoM = daoM.getApplyView(reg_id);
%>
<!doctype html>
<html lang="ko">
	...
	<body>
		...
		<div class="notice">
			...
			<form name="write">
				...
				<input type="hidden" name="t_event_m_no" value="<%=event_m_no%>">
					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td colspan="2"><textarea type="cont" name="cont" id="cont" class="cont"><%=dtoM.getContent()%></textarea>
							</tr>
