					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td><input type="text" name="t_title" id="title" class="title" value="<%=dtoW.getTitle()%>" placeholder="제목을 입력해주세요"></td>
							</tr>
							
							<tr>
								<th><label for="cont">내용</label></th>
								<td><textarea type="cont" name="t_content" id="cont" class="cont" placeholder="내용을 입력해주세요"><%=dtoW.getContent()%></textarea>
							</tr>
							...
							<% if(dtoW.getFile_name_1() != null) { %>	
									<p><a href="/common/filedown.jsp?t_file=<%=dtoW.getFile_name_1()%>&t_gubun=notice"><%=dtoW.getFile_name_1()%>
									&nbsp;&nbsp;파일 삭제
